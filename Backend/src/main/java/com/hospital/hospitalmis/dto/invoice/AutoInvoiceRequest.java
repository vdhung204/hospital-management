...
public class AutoInvoiceRequest {
    ...
    public Boolean getIncludeConsult() {
        return includeConsult;
    }

    public void setIncludeConsult(Boolean includeConsult) {
        this.includeConsult = includeConsult;
    }
    ...
    public Boolean getIncludeImaging() {
        return includeImaging;
    }

    public void setIncludeImaging(Boolean includeImaging) {
        this.includeImaging = includeImaging;
    }

    public Boolean getIncludeDrugs() {
        return includeDrugs;
    }

    public void setIncludeDrugs(Boolean includeDrugs) {
        this.includeDrugs = includeDrugs;
    }
}
